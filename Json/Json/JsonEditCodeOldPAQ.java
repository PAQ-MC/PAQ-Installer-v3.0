...
public class JsonEditCodeOldPAQ {

    public static void Main(String jsonlocation, String PAQv, String gameDir) throws IOException, InvalidSyntaxException
    {
        ...
        JsonField[] fields = new JsonField[] {
            JsonNodeFactories.field("name", JsonNodeFactories.string("PAQ164")),
            JsonNodeFactories.field("gameDir", JsonNodeFactories.string(gameDir)),            
            JsonNodeFactories.field("lastVersionId", JsonNodeFactories.string("1.6.4-Forge9.11.1.965")),
